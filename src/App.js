  ...
  return (
    <div className={`app-shell ${isAr ? 'lang-ar' : 'lang-en'}`} data-theme={theme}
      ...
      <footer style={{backgroundColor:'var(--bg)', borderTop:'1px solid rgba(197,168,128,0.2)', padding:'40px 24px 30px', textAlign:'center'}}>
        ...
        <p style={{color:'var(--text-dim)', fontSize:'12px', marginBottom:'22px'}}>
        ...
        {/* Share buttons */}
        <p style={{color:'var(--text-dim)', fontSize:'11px', letterSpacing:'.05em', marginBottom:'12px'}}>
          {isAr ? 'شارك هذا البورتفوليو' : 'SHARE THIS PORTFOLIO'}
        </p>
        <div style={{display:'flex', gap:'12px', justifyContent:'center', marginBottom:'26px'}}>
          <a href={`https://wa.me/?text=${encodeURIComponent((isAr ? 'شوف البورتفوليو بتاع حاتم قنديل: ' : "Check out Hatem Kandeel's portfolio: ") + 'https://hatem-kandeel-portfolio.vercel.app/')}`}
            target="_blank" rel="noopener noreferrer" className="theme-toggle" aria-label="Share on WhatsApp">
          ...
          <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://hatem-kandeel-portfolio.vercel.app/')}`}
            target="_blank" rel="noopener noreferrer" className="theme-toggle" aria-label="Share on LinkedIn">
        ...
        <p style={{color:'var(--text-dim)', fontSize:'10px', opacity:.6, marginTop:'6px'}}>
